...
class AzureOpenAIProcessor implements NaturalLanguageProcessorInterface
{
    ...
    {
        $this->isAzureOpenAiAvailable = $this->checkAzureOpenAiAvailability();
    ...
    protected function checkAzureOpenAiAvailability(): bool
    {
        try {
    ...
    protected function makeAzureOpenAiRequest(string $prompt): string
    {
        $config = config('filament-natural-language-filter.azure');
